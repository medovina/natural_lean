...
-- This file contains the Set type, copied from Mathlib.  You may use it if you want
-- to use set comprehensions in Natural Lean without pulling in all of Mathlib.
--
...
-- Natural Lean syntax extensions
